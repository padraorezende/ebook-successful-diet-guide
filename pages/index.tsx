...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100">
      ...
      {/* <header className="w-full shadow-md bg-teal-600">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-2 md:mb-0">
            <h1 className={`text-4xl font-bold leading-tight ${inter.className}`} >
              O GUIA IDEAL PARA UMA DIETA DE SUCESSO:
            </h1>
            <div className="inline-flex items-center">
              <h2 className={`text-3xl font-bold leading-tight ${inter.className}`} >
                Saiba como alcançar seus objetivos
              </h2>
              <img src="/images/objective.png" alt="Stripe" className="w-8 ml-2" />
            </div>
          </div>
          <a href="#" className="text-blue-600 hover:text-blue-800 font-medium hidden">
            Ver outros produtos
          </a>
        </div>
      </header> */}

      <div className="text-center mt-14 mb-2 md:mb-0">
        <h1 className={`text-5xl font-bold leading-tight ${inter.className}`} >
          O GUIA IDEAL PARA UMA DIETA DE SUCESSO:
        </h1>
        <div className="inline-flex items-center">
          <h2 className={`text-4xl font-bold leading-tight ${inter.className}`} >
            Saiba como alcançar seus objetivos
          </h2>
          <img src="/images/objective.png" alt="Stripe" className="w-8 ml-2" />
        </div>
      ...
      <div className="py-12 h-full flex-col text-center">
        <h2 className="text-xl font-bold text-gray-800 mb-12">
          Programa de Reeducação Alimentar Ajuda <div className="text-xl  text-red-600">Mais de 75.000 Pessoas em 7 Países nos Últimos 2 Anos</div>que
          Precisavam Reduzir Drasticamente Suas <div className='inline-flex underline'>GORDURAS CORPORAIS</div> em Poucos Dias
        </h2>
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <div className="md:w-1/2 mt-8 mx-2 flex flex-col items-center">
            <button className="py-3 bg-lime-500 hover:bg-lime-600 text-white rounded-lg shadow-lg font-medium w-4/5"
              onClick={() => window.location.href = "https://checkout.ticto.app/O34A48766"}>
              SIM, EU QUERO PERDER <br /> GORDURA LOCALIZADA E EMAGRECER!
            </button>
        ...
        <div className="max-w-7xl mx-auto py-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center">
            <Card description='"Segui o guia e perdi 3 quilos em uma semana, estou muito feliz. Conteúdo muito didático e simples de entender"' location='São Paulo' name='João Silva' />
